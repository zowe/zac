*Adapted from Open Mainframe Project Top Level Project Graduation Criteria at https://github.com/openmainframeproject/tsc/blob/master/process/example_governance.md*
...
The project committers will elect a lead ( and optionally a co-lead ) which will be the primary point of contact for the project. The lead(s) will be responsible for the overall project health and direction, coordination of activities, and working with other projects and committees as needed for the continuted growth of the project.
